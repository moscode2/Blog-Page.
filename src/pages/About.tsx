...
const About = () => {
  const canonical =
    typeof window !== "undefined"
      ...
      : "https://94522e3f-9a15-4291-b133-8a56b3a03438.lovableproject.com/about";
  ...
  return (
    <main>
      <Helmet>
        ...
        <meta
          name="description"
          content="YOUR SHARP, NO-FLUFF GUIDE TO MAKING SENSE OF MONEY LAWS AND EVERYTHING IN BETWEEN."
        />
      ...
      <section className="container mx-auto grid items-center gap-10 py-16 md:grid-cols-2">
        <div>
          <img
            src={flowerImage}
            alt="Flower"
            className="mx-auto w-full max-w-sm rounded-2xl object-cover shadow"
          />
        </div>
